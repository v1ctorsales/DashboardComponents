...
<a href="https://www.creative-tim.com/product/soft-ui-dashboard" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Free download</a>
            ...
            <section>
                ...
                <p class="mb-0">Digite seu e-mail e senha para acessar a plataforma</p>
                </div>
                <div class="card-body">
                <form role="form">
                <label>Email</label>
                ...
                <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                    <div className="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style={{backgroundImage: `url(${bgImage})`}}></div>
                </div>
                </div>
                </div>
                </div>
